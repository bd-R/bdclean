...
#'@section Citation:
#'\itemize{
#'\item Gueta, T., Barve, V., Nagarajah, T., Agrawal, A. & Carmel, Y. (2017). bdclean: Biodiversity data cleaning workflows (R package V 1.0.0). Retrieved from https://github.com/bd-R/bdclean/
#'}
#'
#' @docType package
#' @name bdclean
